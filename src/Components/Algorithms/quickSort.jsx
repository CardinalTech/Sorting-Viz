import { FINAL_COLOR, MakeDelay, POSITION_FINAL_COLOR, PRIMARY_COLOR, COMPARE_COLOR, SWAP_COLOR, Swap, randomNumberFrom, MIN_COLOR, disableAllButtons, delay } from "../Helper_Functions/functions.jsx";
...
async function partition(ele, s, e) {
	...
	ele[e].style.background = PRIMARY_COLOR;    // pivot to starting color
	await MakeDelay(delay);
